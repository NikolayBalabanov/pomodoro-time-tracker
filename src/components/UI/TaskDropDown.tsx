...
export default function TaskDropDown() {
  return (
    <ul className="dropdown absolute w-[165px] h-[153px] py-[5px] list-none top-[44px] -right-[69px] border border-colorGrey bg-white">
      <li>
        <button className="w-full py-[9px] px-[14px] flex items-center hover:bg-colorBg">
          <svg
            className="mr-2"
            width="18"
            height="18"
          ...
          <span className="text-base leading-[17px]">Увеличить</span>
        </button>
      </li>
      <li>
        <button className="w-full py-[9px] px-[14px] flex items-center hover:bg-colorBg">
          ...
          <span className="text-base leading-[17px]">Уменьшить</span>
        </button>
      </li>
      <li>
        <button className="w-full py-[9px] px-[14px] flex items-center hover:bg-colorBg">
          ...
          <span className="text-base leading-[17px]">Редактировать</span>
        </button>
      </li>
      <li>
        <button className="w-full py-[9px] px-[14px] flex items-center hover:bg-colorBg">
          ...
          <span className="text-base leading-[17px]">Удалить</span>
        </button>
      </li>
    </ul>
  );
